...
2. **Updated Documentation & Guidelines**:
   - Updated template path rule in [`AGENTS.md`](file:///home/cspark/Work/projects/plasma_column/AGENTS.md) to reference `docs/site/index.html` and `docs/site/style.css`.
