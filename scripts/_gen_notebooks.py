...
def make_seeded_nb(gas, pressure, neutralization, fname):
    ...
    cells = [
        ...
        code([
            ...
            "SCRIPT = _ROOT / 'scripts' / 'plasma_column_mcc_picmi_v7.py'\n",
            "_DEFAULTS = {\n",
            f"    'script':               'scripts/plasma_column_mcc_picmi_v7.py',\n",
            f"    'case':                 '{cn}',\n",
            f"    'gas':                  '{gas}',\n",
...
def make_callback_nb(gas, pressure, fname):
    ...
    cells = [
        ...
        code([
            "from plasma_column.notebook_utils import print_simulation_config\n",
            "SCRIPT = _ROOT / 'scripts' / 'plasma_column_callback_source_picmi_v3.py'\n",
            "_DEFAULTS = {\n",
            f"    'script':                'scripts/plasma_column_callback_source_picmi_v3.py',\n",
            f"    'case':                  '{cn}',\n",
            f"    'gas':                   '{gas}',\n",
            f"    'pressure_torr':         '{pressure}',\n",
            "    'max_steps':             20000,\n",
...
def make_parameter_scan_run_nb():
    cells = [
        ...
        code([
            ...
            "\n",
            "SCRIPT_SEEDED   = _ROOT / 'scripts' / 'plasma_column_mcc_picmi_v7.py'\n",
            "SCRIPT_CALLBACK = _ROOT / 'scripts' / 'plasma_column_callback_source_picmi_v3.py'\n",
            "\n",
...
def make_parameter_scan_analysis_nb():
    cells = [
        ...
        code([
            ...
            "_scan_s = ScanMatrix(\n",
            "    scan_name='pressure_scan', script=_ROOT/'scripts'/'plasma_column_mcc_picmi_v7.py',\n",
            "    parameters=[ScanParameter('pressure_torr', PRESSURES)],\n",
            "    gases=['H2','Kr'], methods=['seeded'], runs_root=RUNS_DIR,\n",
            ")\n",
            "# Pressure scan index (callback)\n",
            "_scan_c = ScanMatrix(\n",
            "    scan_name='callback_scan', script=_ROOT/'scripts'/'plasma_column_callback_source_picmi_v3.py',\n",
            "    parameters=[ScanParameter('pressure_torr', PRESSURES)],\n",
