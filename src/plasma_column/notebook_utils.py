...
COMMON_IMPORTS = [
    ...
    ")\n",
    "from plasma_column.hardware import configure_runtime, detect_gpu\n",
    "# Hardware setup: default 16 CPU cores, auto-detect GPU (defaults to GPU 0 if available)\n",
    "HW_CONFIG      = configure_runtime(cores=16, gpu='auto')\n",
